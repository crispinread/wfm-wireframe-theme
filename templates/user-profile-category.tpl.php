 ...
 */
?>
<?php if ($title && $title != t('Name and Address')): ?>
  <h3><?php print $title; ?></h3>
<?php elseif ($title && $title == t('Name and Address')): ?>
	<h3><?php print $title; ?><span class="edit-details"><a href="/user/<?php echo $user->uid; ?>/edit">[Edit Details]</a></span></h3>
<?php endif; ?>
